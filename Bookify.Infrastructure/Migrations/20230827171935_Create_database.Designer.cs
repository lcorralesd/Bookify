...
namespace Bookify.Infrastructure.Migrations
{
    ...
    [Migration("20230827171935_Create_database")]
            ...
            modelBuilder.Entity("Bookify.Domain.Bookings.Booking", b =>
                {
                    ...
                    b.OwnsOne("Bookify.Domain.Shared.Money", "ClieaningFee", b1 =>
                        {
                            b1.Property<Guid>("BookingId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                            ...
                            b1.Property<decimal>("Amount")
                                .HasColumnType("numeric")
                                .HasColumnName("clieaning_fee_amount");

                            b1.Property<string>("Currency")
                                .IsRequired()
                                .HasColumnType("text")
                                .HasColumnName("clieaning_fee_currency");
